...
> ## 📢 Versión activa: **IEDNavigator PRO**
>
> Este repositorio corresponde a la versión **3.4** y se conserva como referencia. El
> desarrollo activo continúa en **[IEDNavigator PRO](https://github.com/MancoQpa/IEDnavigatorPRO)**,
> que amplía esta base con: control de maniobra reforzado (SBO con seguridad reforzada, SBO en
> dos pasos y verificación de posición, validado contra un relé NARI PCS-9611S), correcciones
> de conformidad GOOSE (IEC 61850-8-1) e instalador autocontenido con runtime de Java incluido.
>
> 👉 **Descargas:** <https://github.com/MancoQpa/IEDnavigatorPRO/releases/latest>
